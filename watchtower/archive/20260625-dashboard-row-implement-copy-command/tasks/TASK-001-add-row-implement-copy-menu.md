# TASK-001 Add Row Implement Copy Menu

Group: standalone

## Brief

Goal: TODO row menu gets command copy item. User can copy row-specific `watchtower implement TASK-NNN` command from each TODO row.
...
- Copy `$watchtower implement TASK-NNN\n` for Codex.
- If adding Claude parity, copy `/watchtower implement TASK-NNN\n`.
...
- Each TODO row exposes menu item that copies `$watchtower implement TASK-NNN`.
