# TODO-004 Blocked notifications

Group: ext (edits src/extension.ts; ships with TODO-003)
...
- In `updateStatus()` (from TODO-003), after reading the plan: call `detectNewlyBlocked(prevStatus, plan.todos)`.
