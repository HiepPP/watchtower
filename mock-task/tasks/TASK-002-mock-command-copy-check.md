# TASK-002 Mock command copy check
...
- [watchtower/tasks/TASK-002-mock-command-copy-check.md](TASK-002-mock-command-copy-check.md) (mock brief)
- [watchtower/tasks/TASK-002-outcome.md](TASK-002-outcome.md) (future outcome)

Expected result:

- Dashboard shows `TASK-002` row under Todo.
- Copy button writes selected Watchtower command to clipboard.

Prompt:

```text
Inspect TASK-002 mock row. Do not change code. Confirm dashboard can show this TODO and copy one Watchtower command.
```

## Verify

- Open Watchtower dashboard -> `TASK-002` row shows under Todo.
